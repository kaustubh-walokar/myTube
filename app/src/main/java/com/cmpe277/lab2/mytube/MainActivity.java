...
public class MainActivity extends AppCompatActivity implements
    ...
    private class GetAccessToken extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                accessToken = GoogleAuthUtil.getToken(getApplicationContext(), session.getLoggedInMail(), Values.SCOPE_STRING);
                session.setToken(accessToken);
            } catch (UserRecoverableAuthException e) {
                startActivityForResult(e.getIntent(), REQ_SIGN_IN_REQUIRED);
            } catch (Exception e) {
                Log.e(Values.TAG,"Exception in getting token", e);
            }
            return accessToken;
        }
